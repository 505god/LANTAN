...
- (void)setup
{
    ...
    self.imgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"login_10"]];
    ...
    self.alertView = [[UIAlertView alloc] initWithTitle:kTip
                                                message:@""
                                               delegate:self
    ...
    void (^animations)() = ^{
        ...
        if (Platform >= 7.0) {
            self.textField.frame = CGRectMake(self.bounds.origin.x + textFieldX,
                                              ...
                                              self.bounds.size.height);
            self.imgView.frame = CGRectMake(self.bounds.origin.x + textFieldX-5,
                                            self.bounds.origin.y+5,
                                            self.bounds.size.width - textFieldX+10,
